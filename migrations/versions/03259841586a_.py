...
Revision ID: 03259841586a
Revises: 08d63f2baa07
Create Date: 2020-07-24 08:58:21.021010
...
revision = '03259841586a'
down_revision = '08d63f2baa07'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('dataConclusao', sa.Date(), nullable=True),
